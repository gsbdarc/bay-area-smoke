...
bootstrap downloads ~1.8 GB from Harvard Dataverse or Dropbox, plus ~100 MB of NOAA
...
| Stage | Time | Network |
|---|---|---|
| `b01` ECHOLab bootstrap | 10–40 min | ~1.8 GB |
| `b02` grid cell selection | < 1 min | 15 MB |
| `s01` EPA bulk 2000–2024 | 15–30 min | ~150 MB |
| `s02` EPA AQS API 2025→ | ~5 min | small (rate-limited on purpose) |
| `s03` NOAA HMS 2005→ | 10–20 min | ~100 MB |
| `s04` build smoke panel | 2–5 min | none |
